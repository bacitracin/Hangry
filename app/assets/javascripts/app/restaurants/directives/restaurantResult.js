...
function restaurantResult() {
  return {
    ...
    template: '<div class="panel-body"><a href="#" ui-sref="restaurant({id: restaurant.id})">{{ restaurant.name}} </a> - {{ restaurant.city }} - <a href="#" ui-sref="edit({id: restaurant.id})">Edit Details</a></div>',
    replace: true
  };
}
